...
public class MovementSlide {
	...
	public void control(EntityPlayerCustom playerCustom, EntityPlayer player, int heading){
		if(!player.capabilities.isFlying){
			if(!player.isSprinting() && playerCustom.wasSprinting){
				if(player.isSneaking() && player.onGround && !playerCustom.isRolling){
	...
	public void renderTick(EntityPlayerCustom playerCustom){
		if(playerCustom.isSneaking || (Minecraft.getMinecraft().theWorld.getBlock(MathHelper.floor_double(Minecraft.getMinecraft().thePlayer.posX), MathHelper.floor_double(Minecraft.getMinecraft().thePlayer.posY), MathHelper.floor_double(Minecraft.getMinecraft().thePlayer.posZ)).isNormalCube() && playerCustom.wasSliding)){
