...
public class Patch {
	...
	private static void setupViewBobbing(EntityRenderer renderer, float par1) {
		if (((Minecraft) ObfuscationReflectionHelper.getPrivateValue(
				EntityRenderer.class, renderer, 5)).renderViewEntity instanceof EntityPlayer) {
	...
	public static void orientCameraPatch(float par1, EntityRenderer renderer) {
		...
		GL11.glRotatef(
				(Float) ObfuscationReflectionHelper.getPrivateValue(
						EntityRenderer.class, renderer, 31)
						+ ((Float) ObfuscationReflectionHelper.getPrivateValue(
								EntityRenderer.class, renderer, 30) - (Float) ObfuscationReflectionHelper
								.getPrivateValue(EntityRenderer.class,
										renderer, 31)) * par1, 0.0F, 0.0F, 1.0F);
		...
		if (entitylivingbase.isPlayerSleeping()) {
			...
			if (!Minecraft.getMinecraft().gameSettings.debugCamEnable) {
				ForgeHooksClient.orientBedCamera(Minecraft.getMinecraft(),
						entitylivingbase);
				GL11.glRotatef(
			...
			double d7 = (double) ((Float) ObfuscationReflectionHelper
					.getPrivateValue(EntityRenderer.class, renderer, 18) + ((Float) ObfuscationReflectionHelper
					.getPrivateValue(EntityRenderer.class, renderer, 17) - (Float) ObfuscationReflectionHelper
					.getPrivateValue(EntityRenderer.class, renderer, 18))
					* par1);
			float f2;
			float f6;

			if (Minecraft.getMinecraft().gameSettings.debugCamEnable) {
				f6 = (Float) ObfuscationReflectionHelper.getPrivateValue(
						EntityRenderer.class, renderer, 20)
						+ ((Float) ObfuscationReflectionHelper.getPrivateValue(
								EntityRenderer.class, renderer, 19) - (Float) ObfuscationReflectionHelper
								.getPrivateValue(EntityRenderer.class,
										renderer, 20)) * par1;
				f2 = (Float) ObfuscationReflectionHelper.getPrivateValue(
						EntityRenderer.class, renderer, 22)
						+ ((Float) ObfuscationReflectionHelper.getPrivateValue(
								EntityRenderer.class, renderer, 21) - (Float) ObfuscationReflectionHelper
								.getPrivateValue(EntityRenderer.class,
										renderer, 22)) * par1;
				...
				double d3 = (double) (-MathHelper.sin(f6 / 180.0F
						* (float) Math.PI) * MathHelper.cos(f2 / 180.0F
						* (float) Math.PI))
						* d7;
				double d4 = (double) (MathHelper.cos(f6 / 180.0F
						* (float) Math.PI) * MathHelper.cos(f2 / 180.0F
						* (float) Math.PI))
						* d7;
				double d5 = (double) (-MathHelper.sin(f2 / 180.0F
						* (float) Math.PI))
						* d7;
				...
				GL11.glRotatef(entitylivingbase.rotationPitch - f2, 1.0F, 0.0F,
						0.0F);
				GL11.glRotatef(entitylivingbase.rotationYaw - f6, 0.0F, 1.0F,
						0.0F);
				GL11.glTranslatef(0.0F, 0.0F, (float) (-d7));
				GL11.glRotatef(f6 - entitylivingbase.rotationYaw, 0.0F, 1.0F,
						0.0F);
		...
		ObfuscationReflectionHelper.setPrivateValue(EntityRenderer.class,
				renderer, Minecraft.getMinecraft().renderGlobal.hasCloudFog(d0,
						d1, d2, par1), 40);
	}
}
